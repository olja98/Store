    ...
    <div class="lg:w-2/3 w-full mx-auto mt-8">
            ...
            <div class="flex flex-wrap -mx-2 mt-4">
                ...
                <div class="p-2 w-1/6">
                 ...
                 <div class="p-2 w-1/6">
                    <div class="relative">
                        <label for="zip_code" class="leading-7 text-sm text-gray-600">Phone</label>
                        <input
                            type="text"
                            id="phone"
                            name="phone"
                 ...
                 <div class="p-2 w-1/6">
                    <div class="relative">
                        <label for="zip_code" class="leading-7 text-sm text-gray-600">Address 2</label>
                        <input
                            type="text"
                            id="address_2"
                            name="address_2"
                 ...
                 <div class="p-2 w-1/6">
                    <div class="relative">
                        <label for="zip_code" class="leading-7 text-sm text-gray-600">District</label>
                        <input
                            type="text"
                            id="district"
                            name="district"
                 ...
                 <div class="p-2 w-1/6">
                    <div class="relative">
                        <label for="zip_code" class="leading-7 text-sm text-gray-600">Other Notes</label>
                        <input
                            type="text"
                            id="other_notes"
                            name="other_notes"
                            class="w-full bg-gray-100 rounded border border-gray-300 focus:border-indigo-500 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
                            v-model="customer.other_notes"
                            :disabled="paymentProcessing"
                        >
                    </div>
                </div>
            ...
            <div class="p-2 w-full">
                <button
                    class="flex mx-auto text-black bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg"
...
<script>
    ...
    export default {
        ...
        methods: {
                ...
                if (error) {
                    ...
                    axios.post('/api/purchase', this.customer)
                        .then((response) => {
                            ...
                            this.$store.commit('updatePayment', response.data);
                            this.$store.dispatch('clearCart');
                            this.$router.push({ name: 'payment.summary' });
                        })
                        .catch((error) => {
                            this.paymentProcessing = false;
                            console.error("second part");
                        });
                }
            }
         ...
         async mounted() {
            this.stripe = await loadStripe('pk_test_51J9wrbKoxy6NfsQPr3rTc9ylo6GhnADvUgI4BDj1M97Ye4AhulOuzqbobCdkFg2bPmekwlS3VjL3SH6OQMrSOabs00h2AtuHF0');
