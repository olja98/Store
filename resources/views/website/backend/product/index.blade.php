...
<div class="col-md-12 col-sm-12 ">
    <div class="x_panel">
      ...
      <div class="x_content">
        ...
        <div id="datatable-responsive_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap no-footer"><div class="row">
</div><div class="row"><div class="col-sm-12"><table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap dataTable no-footer dtr-inline" cellspacing="0" width="100%" role="grid" aria-describedby="datatable-responsive_info" style="width: 100%;">
          <thead>
            <tr role="row">
          ...
          <td>{{$procat->category->brand}}</td>
          <td>{{$procat->product_name}}</td>
          <td>{{$procat->price}}</td>
          <td>{{$procat->status}}</td>
          <td>{{$procat->product_description}}</td>
